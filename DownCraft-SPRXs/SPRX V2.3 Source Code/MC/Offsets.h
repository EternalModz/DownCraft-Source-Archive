...
namespace Offsets
{
	...
	void GET_SPECIAL_ITEMS(bool toggle)
	{
		if (toggle)
		{
			SetNotify(L"Get Special Items: ON");
		}
		else
		{

			SetNotify(L"Get Special Items: OFF");
		}
	}
	...
	void ADD_CUSTOM_BANNER_SMALL() //for small screen
	{
		if (UI::Settings::ShowCustomBannerSmall)
		{
			if (OpenMenu)
			{
				*(int*)0x30927421 = 0x00000000; //TEXT INVENTORY
				...
				*(int*)0x31E7782C = 0x42630000; //pos
				*(int*)0x31E77830 = 0xC3CC0000; //pos
			}
			else
			{
	...
	void ADD_CUSTOM_BANNER_BIG() //big screen
	{
		if (UI::Settings::ShowCustomBannerBig)
		{
			if (OpenMenu)
			{
				*(int*)0x30927421 = 0x00000000; //TEXT INVENTORY
				...
				*(int*)0x31E7782C = 0x41F10000; //pos
				*(int*)0x31E77830 = 0xC3980000; //pos
			}
			else
			{
				*(int*)0x31E7782C = 0x49B00000; //pos
	...
	void INVENTORY_CREATIVE_TUMBLE(bool toggle)
	{
		if (toggle)
		{
