...
namespace SubMenu
{
	...
	void NonHostMenu3()
	{
		...
		AddBoolOption(L"No Colission Entity", !NoColissionEntity);
		AddBoolOption(L"Always On Crouch", !AlwaysOnCrouch);
		AddBoolOption(L"Get Players IDs", !GetPlayersIDs);
		AddBoolOption(L"Players On Elyta", !PlayersOnElytra);
	...
	void NonHostMenu4()
	{
		submmenuMax = 14;
		AddHud(submmenuMax);
		AddTitle(L"No Host Options 4");
		AddBoolOption(L"Jump In Lava", !JumpInLava);
		AddBoolOption(L"Crouch Movement", !CrouchMovement);
		...
		AddBoolOption(L"Return In XMB", !ReturnInXMB);
		AddBoolOption(L"Return In XMB V2", !ReturnInXMBV2);
		AddBoolOption(L"Add Fake Clone", !AddFakeClone);
		AddBoolOption(L"Invisible Players", !InvisiblePlayers);
	...
	void NonHostMenu5()
	{
		submmenuMax = 14;
		AddHud(submmenuMax);
		AddTitle(L"No Host Options 5");
		AddBoolOption(L"Game Speed Static", !GameSpeedStatic);
		AddBoolOption(L"Get 64 Items", !Get64Items);
		AddBoolOption(L"Auto Jump", !AutoJump);
		AddBoolOption(L"Auto Change View", !AutoChangeView);
		...
		AddBoolOption(L"Get Special Items", !GetSpecialItems);
	...
	void NonHostMenu7()
	{
		submmenuMax = 9;
		AddHud(submmenuMax);
		AddTitle(L"No Host Options 7");
		AddBoolOption(L"Block Crack Static", !BlockStaticCrack);
	...
	void CustomImageMenu()
	{
		submmenuMax = 6;
		AddHud(submmenuMax);
		AddTitle(L"Custom Image");
		AddOption(L"Add Image");
		AddBoolOption(L"Add Banner Small", !UI::Settings::ShowCustomBannerSmall);
		AddBoolOption(L"Add Banner Big", !UI::Settings::ShowCustomBannerBig);
