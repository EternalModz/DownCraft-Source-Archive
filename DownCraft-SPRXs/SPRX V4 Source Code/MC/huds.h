...
void DrawToggleONOFFV2(float x, float y, int *Color1, int *Color2, bool checked)
{
	...
	if (checked)
	{
		drawText("OFF     ", x + 2, y, color(OFF));
	}
	else
	{
		drawText("ON     ", x + 2, y, color(ON));
	}
}
...
void Scrollbar()
{
	...
	{ 
		drawRect(ScrollX, ScrollY + 10 + (CurrentOpt * 10), bgW + menulenght, 11, GetThemeColor());
...
void AddTitle(const wchar_t* title)
{
	...
	{
		drawRect(textX - 10, textY - 13, bgW + menulenght, textI + 4, GetThemeColor());
	}

	Scrollbar();
	AddOpacityBG();

	DrawShadowText(title, TitleTextX + menulenght, TitleTextY, color(UI::Color::WHITE));
}
...
{
	CountIndexPage();
	drawRect(ScrollX, ScrollY, bgW + menulenght, 11, UI::Color::BLACK2);
	DrawShadowText(desc, AddOptX - 3, AddOptY - 10, color(UI::Color::WHITE));
	char option4[0x100];
	...
	if (CurrentIndex > 9)
	{
		UI_DrawText(woption4, TitleTextX + 76 + menulenght, TitleTextY + 12, color(UI::Color::WHITE)); //574
	}
	else
	{
		UI_DrawText(woption4, TitleTextX + 81 + menulenght, TitleTextY + 12, color(UI::Color::WHITE)); //579 title = 448
	}
}
...
void AddInformation(int sub, const wchar_t* desc)
{
	...
	{
		if (sub == 1) { drawRect(bgX, bgY + 10, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 2) { drawRect(bgX, bgY + 20, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 3) { drawRect(bgX, bgY + 30, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 4) { drawRect(bgX, bgY + 40, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 5) { drawRect(bgX, bgY + 50, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 6) { drawRect(bgX, bgY + 60, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 7) { drawRect(bgX, bgY + 70, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 8) { drawRect(bgX, bgY + 80, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 9) { drawRect(bgX, bgY + 90, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 10) { drawRect(bgX, bgY + 100, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 11) { drawRect(bgX, bgY + 110, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 12) { drawRect(bgX, bgY + 120, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 13) { drawRect(bgX, bgY + 130, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 14) { drawRect(bgX, bgY + 140, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 15) { drawRect(bgX, bgY + 150, bgW + menulenght, 11, GetThemeColor()); }
		else if (sub == 16) { drawRect(bgX, bgY + 160, bgW + menulenght, 11, GetThemeColor()); }
	}

	//TEXT

	if (sub == 1) { DrawShadowText(desc, AddOptX - 3, AddOptY + 10, color(UI::Color::WHITE)); }
	else if (sub == 2) { DrawShadowText(desc, AddOptX - 3, AddOptY + 20, color(UI::Color::WHITE)); }
	else if (sub == 3) { DrawShadowText(desc, AddOptX - 3, AddOptY + 30, color(UI::Color::WHITE)); }
	else if (sub == 4) { DrawShadowText(desc, AddOptX - 3, AddOptY + 40, color(UI::Color::WHITE)); }
	else if (sub == 5) { DrawShadowText(desc, AddOptX - 3, AddOptY + 50, color(UI::Color::WHITE)); }
	else if (sub == 6) { DrawShadowText(desc, AddOptX - 3, AddOptY + 60, color(UI::Color::WHITE)); }
	else if (sub == 7) { DrawShadowText(desc, AddOptX - 3, AddOptY + 70, color(UI::Color::WHITE)); }
	else if (sub == 8) { DrawShadowText(desc, AddOptX - 3, AddOptY + 80, color(UI::Color::WHITE)); }
	else if (sub == 9) { DrawShadowText(desc, AddOptX - 3, AddOptY + 90, color(UI::Color::WHITE)); }
	else if (sub == 10) { DrawShadowText(desc, AddOptX - 3, AddOptY + 100, color(UI::Color::WHITE)); }
	else if (sub == 11) { DrawShadowText(desc, AddOptX - 3, AddOptY + 110, color(UI::Color::WHITE)); }
	else if (sub == 12) { DrawShadowText(desc, AddOptX - 3, AddOptY + 120, color(UI::Color::WHITE)); }
	else if (sub == 13) { DrawShadowText(desc, AddOptX - 3, AddOptY + 130, color(UI::Color::WHITE)); }
	else if (sub == 14) { DrawShadowText(desc, AddOptX - 3, AddOptY + 140, color(UI::Color::WHITE)); }
	else if (sub == 15) { DrawShadowText(desc, AddOptX - 3, AddOptY + 150, color(UI::Color::WHITE)); }
	else if (sub == 16) { DrawShadowText(desc, AddOptX - 3, AddOptY + 160, color(UI::Color::WHITE)); }
}
	...
	if (UI::Settings::Rainbow)
	{
		...
		else
		{
			if (UI::Settings::Scrollbar)
			{
				...
				{
					UI_DrawText(boolOption ? L"" : L"+     ", CheckBoxX + menulenght - 21, CheckBoxY + (10 * MaxOption), color(UI::Color::WHITE));
				}
			}
			else
			{
				...
				{
					UI_DrawText(boolOption ? L"" : L"+     ", CheckBoxX + menulenght - 21, CheckBoxY + (10 * MaxOption), (MaxOption == CurrentOpt) ? color(UI::Color::RainbowRED, UI::Color::RainbowGREEN, UI::Color::RainbowBLUE) : color(UI::Color::WHITE));
				}
			}
		}
	...
	else
	{
		...
		else
		{
			...
			else
			{
				...
				{
					UI_DrawText(boolOption ? L"" : L"+     ", CheckBoxX + menulenght - 21, CheckBoxY + (10 * MaxOption), (MaxOption == CurrentOpt) ? color(GetThemeColor()) : color(UI::Color::WHITE));
				}
			}
		}
		if (UI::Settings::CheckboxV2 && !UI::Settings::Checkbox)
...
void AddIntOption(const wchar_t* opt, int IntOptions)
{
	...
	*/
	...
	if (IntOptions > 99)
	{
		UI_DrawText(woption46, CheckBoxX - 27 + menulenght, CheckBoxY + (10 * MaxOption), color(UI::Color::WHITE));
	}
	else
	{
		UI_DrawText(woption46, CheckBoxX - 24 + menulenght, CheckBoxY + (10 * MaxOption), color(UI::Color::WHITE));
	}
	MaxOption += 1;
}
