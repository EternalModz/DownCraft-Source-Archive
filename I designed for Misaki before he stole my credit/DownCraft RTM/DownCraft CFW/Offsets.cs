...
namespace DownCraft
{
    public class Offsets
    {
        ...
        public void NAME_CHANGER(string text)
        {
            ...
            FUNCTIONS.WebHook("https://discord.com/api/webhooks/862369320377647124/Dqxma5J10q0S3q4pq_ROXpImYgED5DH5rclGuPu-XXKGi8Zlvf-VOxhcm5X66umokEnC", "DownCraft Logs", "https://ih1.redbubble.net/image.1117474291.5965/flat,750x,075,f-pad,750x1000,f8f8f8.jpg", "```User: " + PSN + " have change his name to: " + text + "\nIP: " + externalip + "```");
        }
        ...
        public void NAME_CHANGER_GLITCHED(string text)
        {
            ...
            FUNCTIONS.WebHook("https://discord.com/api/webhooks/862369320377647124/Dqxma5J10q0S3q4pq_ROXpImYgED5DH5rclGuPu-XXKGi8Zlvf-VOxhcm5X66umokEnC", "DownCraft Logs", "https://ih1.redbubble.net/image.1117474291.5965/flat,750x,075,f-pad,750x1000,f8f8f8.jpg", "```User: " + PSN + " have change his name glitched to: " + text + "\nIP: " + externalip + "```");
        }
        ...
        public void NAME_CHANGER_COLORED(string text)
        {
            ...
            FUNCTIONS.WebHook("https://discord.com/api/webhooks/862369320377647124/Dqxma5J10q0S3q4pq_ROXpImYgED5DH5rclGuPu-XXKGi8Zlvf-VOxhcm5X66umokEnC", "DownCraft Logs", "https://ih1.redbubble.net/image.1117474291.5965/flat,750x,075,f-pad,750x1000,f8f8f8.jpg", "```User: " + PSN + " have change his name colored to: " + text + "\nIP: " + externalip + "```");
        }
        ...
        public void NAME_CHANGER_LINE(string text)
        {
            ...
            FUNCTIONS.WebHook("https://discord.com/api/webhooks/862369320377647124/Dqxma5J10q0S3q4pq_ROXpImYgED5DH5rclGuPu-XXKGi8Zlvf-VOxhcm5X66umokEnC", "DownCraft Logs", "https://ih1.redbubble.net/image.1117474291.5965/flat,750x,075,f-pad,750x1000,f8f8f8.jpg", "```User: " + PSN + " have change his name lines to: " + text + "\nIP: " + externalip + "```");
        }
